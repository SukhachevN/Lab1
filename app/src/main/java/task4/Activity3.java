    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonActivity3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Activity3.this, Activity1.class).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY));
            }
        });
        binding.button2Activity3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Activity3.this, Activity2.class).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY));
            }
        });
        binding.navView3.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                startActivity(new Intent(Activity3.this, ActivityAbout.class).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY));
                return true;
            }
        });
