    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonActivity1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Activity1.this, Activity2.class).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY));
            }
        });
        binding.navView1.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                startActivity(new Intent(Activity1.this, ActivityAbout.class).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY));
                return true;
            }
        });
    }
